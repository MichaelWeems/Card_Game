...
import com.se339.pixel_hockey.Sprites.Enemies.*;
...
public class Mario extends Sprite {
    ...
    public void update(float dt){
        ...
        if(marioIsBig)
            setPosition(b2body.getPosition().x - getWidth() / 2, b2body.getPosition().y - getHeight() / 2 - 6 / PixelHockeyGame.PPM);
        else
    ...
    public void grow(){
        if( !isBig() ) {
            ...
            PixelHockeyGame.manager.get("audio/sounds/powerup.wav", Sound.class).play();
        }
    }
    ...
    public void defineBigMario(){
        ...
        BodyDef bdef = new BodyDef();
        bdef.position.set(currentPosition.add(0, 10 / PixelHockeyGame.PPM));
        bdef.type = BodyDef.BodyType.DynamicBody;
        b2body = world.createBody(bdef);
        ...
        fdef.shape = shape;
        b2body.createFixture(fdef).setUserData(this);
        shape.setPosition(new Vector2(0, -14 / PixelHockeyGame.PPM));
        b2body.createFixture(fdef).setUserData(this);
