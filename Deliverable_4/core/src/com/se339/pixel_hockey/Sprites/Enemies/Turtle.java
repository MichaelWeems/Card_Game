...
/**
 * Created by se339.pixel_hockey on 10/10/15.
 */
public class Turtle extends Enemy {
    ...
    public Turtle(PlayScreen screen, float x, float y) {
        ...
        setBounds(getX(), getY(), 16 / PixelHockeyGame.PPM, 24 / PixelHockeyGame.PPM);
    ...
    public void update(float dt) {
        ...
        setPosition(b2body.getPosition().x - getWidth() / 2, b2body.getPosition().y - 8 /PixelHockeyGame.PPM);
